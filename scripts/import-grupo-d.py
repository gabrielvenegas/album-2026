#!/usr/bin/env python3
"""Recorta figurinhas do PDF Grupo D (grid 4x4) e salva em public/stickers/."""
...
PDF = Path("/Users/marllondiniz/Desktop/GRUPO D.pdf")
...
def main() -> None:
    ...
    manifest = ROOT / "src" / "data" / "grupo-d-images.json"
